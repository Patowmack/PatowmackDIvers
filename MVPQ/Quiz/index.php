...
function languageSetUp()
{
   ...
   {
   case "Bahasa":
      $database = "sqlite:quizBahasa.sqlite3";
      $keyboard = "KB_Bahasa.png";
      break;

   case "Dutch":
      $database = "sqlite:quizDutch.sqlite3";
      $keyboard = "KB_Dutch.png";
      break;

   case "French":
      $database = "sqlite:quizFrench.sqlite3";
      $keyboard = "KB_French.png";
      break;

   case "Italian":
      $database = "sqlite:quizItalian.sqlite3";
      $keyboard = "KB_Italian.png";
      break;

   case "Spanish":
      $database = "sqlite:quizSpanish.sqlite3";
      $keyboard = "KB_Spanish.png";
      break;

   case "Swahili":
      $database = "sqlite:quizSwahili.sqlite3";
...
printf("<H2><A HREF=/Quiz/index.php>Eric's English->%s Quiz</a></H2>\n", $language);
?>
...
<DIV ID="top"></DIV>
<?php printf("<H2>Eric's Bahasa/Dutch/French/Italian/Spanish/Swahili Language Quiz</H2>"); ?>
<DIV ID="container">
